...
resource "octopusdeploy_project" "deploy_project_two" {
  auto_create_release                  = false
  default_guided_failure_mode          = "EnvironmentDefault"
  default_to_skip_if_already_installed = false
...
resource "octopusdeploy_variable" "variabled" {
  owner_id     = "${octopusdeploy_project.deploy_project_two.id}"
  value        = "WhateverD"
  name         = "VariableD"
  type         = "String"
  description  = ""
...
resource "octopusdeploy_deployment_process" "deployment_process_project_two" {
  project_id = "${octopusdeploy_project.deploy_project_two.id}"
  ...
  step {
    ...
    action {
      ...
      properties                         = {
        "Octopus.Action.Script.ScriptSource" = "Inline"
        "Octopus.Action.Script.Syntax" = "Bash"
        "Octopus.Action.Script.ScriptBody" = "echo \"#{VariableC} #{VariableD}\""
      }
